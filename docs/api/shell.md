...
```shell
curl --request GET \
  --url https://api.sign.morningcrunch.cloudm/submissions \
...
```shell
curl --request GET \
  --url https://api.sign.morningcrunch.cloudm/submissions/1001 \
  --header 'X-Auth-Token: API_KEY'
```
...
```shell
curl --request GET \
  --url https://api.sign.morningcrunch.cloudm/submissions/1001/documents \
  --header 'X-Auth-Token: API_KEY'
```
...
```shell
curl --request POST \
  --url https://api.sign.morningcrunch.cloudm/submissions/pdf \
  --header 'X-Auth-Token: API_KEY' \
  --header 'content-type: application/json' \
...
```shell
curl --request POST \
  --url https://api.sign.morningcrunch.cloudm/submissions/docx \
  --header 'X-Auth-Token: API_KEY' \
  --header 'content-type: application/json' \
...
```shell
curl --request POST \
  --url https://api.sign.morningcrunch.cloudm/submissions/html \
  --header 'X-Auth-Token: API_KEY' \
  --header 'content-type: application/json' \
...
```shell
curl --request GET \
  --url https://api.sign.morningcrunch.cloudm/submitters \
  --header 'X-Auth-Token: API_KEY'
```
...
```shell
curl --request GET \
  --url https://api.sign.morningcrunch.cloudm/submitters/500001 \
  --header 'X-Auth-Token: API_KEY'
```
...
```shell
curl --request GET \
  --url https://api.sign.morningcrunch.cloudm/templates \
  --header 'X-Auth-Token: API_KEY'
```
...
```shell
curl --request GET \
  --url https://api.sign.morningcrunch.cloudm/templates/1000001 \
  --header 'X-Auth-Token: API_KEY'
```
...
```shell
curl --request POST \
  --url https://api.sign.morningcrunch.cloudm/templates/pdf \
  --header 'X-Auth-Token: API_KEY' \
  --header 'content-type: application/json' \
...
```shell
curl --request POST \
  --url https://api.sign.morningcrunch.cloudm/templates/docx \
  --header 'X-Auth-Token: API_KEY' \
  --header 'content-type: application/json' \
...
```shell
curl --request POST \
  --url https://api.sign.morningcrunch.cloudm/templates/html \
  --header 'X-Auth-Token: API_KEY' \
  --header 'content-type: application/json' \
...
```shell
curl --request POST \
  --url https://api.sign.morningcrunch.cloudm/templates/1000001/clone \
  --header 'X-Auth-Token: API_KEY' \
  --header 'content-type: application/json' \
...
```shell
curl --request POST \
  --url https://api.sign.morningcrunch.cloudm/templates/merge \
  --header 'X-Auth-Token: API_KEY' \
  --header 'content-type: application/json' \
...
```shell
curl --request PUT \
  --url https://api.sign.morningcrunch.cloudm/templates/1000001/documents \
  --header 'X-Auth-Token: API_KEY' \
  --header 'content-type: application/json' \
