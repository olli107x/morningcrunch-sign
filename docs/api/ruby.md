...
```ruby
require "morningcrunch-sign"

morningcrunch Sign.key = ENV["DOCUSEAL_API_KEY"]
morningcrunch Sign.url = "https://api.sign.morningcrunch.cloudm"

morningcrunch Sign.list_submissions(limit: 10)
```
...
morningcrunch Sign.get_submission(1001)
```
...
morningcrunch Sign.get_submission_documents(1001)
```
...
morningcrunch Sign.create_submission({
  template_id: 1000001,
  send_email: true,
  submitters: [
    {
...
morningcrunch Sign.create_submission_from_pdf({
...
morningcrunch Sign.create_submission_from_docx({
  name: "Test Submission Document",
  variables: {
    variable_name: "value"
  },
...
morningcrunch Sign.create_submission_from_html({
  name: "Test Submission Document",
  documents: [
    {
      name: "Test Document",
...
morningcrunch Sign.archive_submission(1001)
```
...
morningcrunch Sign.list_submitters(limit: 10)
```
...
morningcrunch Sign.get_submitter(500001)
```
...
morningcrunch Sign.update_submitter(500001, {
  email: "john.doe@example.com",
  fields: [
    {
      name: "First Name",
...
morningcrunch Sign.list_templates(limit: 10)
```
...
morningcrunch Sign.get_template(1000001)
```
...
morningcrunch Sign.create_template_from_pdf({
  name: "Test PDF",
  documents: [
    {
      name: "string",
...
morningcrunch Sign.create_template_from_docx({
  name: "Test DOCX",
  documents: [
    {
      name: "string",
...
morningcrunch Sign.create_template_from_html({
  html: "<p>Lorem Ipsum is simply dummy text of the
<text-field
  name=\"Industry\"
  role=\"First Party\"
...
morningcrunch Sign.clone_template(1000001, {
...
morningcrunch Sign.merge_templates({
  template_ids: [
    321,
    432
  ],
...
morningcrunch Sign.update_template(1000001, {
...
morningcrunch Sign.update_template_documents(1000001, {
  documents: [
    {
      file: "string"
    }
...
morningcrunch Sign.archive_template(1000001)
```
