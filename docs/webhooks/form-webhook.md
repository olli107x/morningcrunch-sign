...
**Related Guides**  
[Download Signed Documents](https://www.sign.morningcrunch.cloudm/guides/download-signed-documents)
      ...
      "submission": {
        ...
        "properties": {
          ...
          "combined_document_url": {
            "type": "string",
            "description": "The URL of the combined documents with audit log. Combined documents can be enabled via <a href=\"https://sign.morningcrunch.cloudm/settings/account\" target=\"_blank\" class=\"link\">/settings/accounts</a>."
          },
          "status": {
            "type": "string",
