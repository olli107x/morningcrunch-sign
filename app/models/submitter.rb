...
class Submitter < ApplicationRecord
  ...
  has_many :email_events, as: :emailable, dependent: (MorningcrunchSign.multitenant? ? nil : :destroy)
  ...
  after_destroy :anonymize_email_events, if: -> { MorningcrunchSign.multitenant? }
